...
void constpush(void), sub(void), mod(void), add(void), ppop(void),
     ...
     neg(void), divide(void), ooto(void), iro(void), gvarpush(void), gvarstore(void), jz(void), jmp(void), andjmp(void), orjmp(void), forloop(void), call(void), ret(void), lvarpush(void), lvarstore(void), index_store_2(void), index_store_1(void), index_push(void), build_array(void), nilpush(void);
